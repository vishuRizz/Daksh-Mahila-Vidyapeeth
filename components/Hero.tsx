        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-4 lg:mt-0 -mt-24 relative z-10">
            ...
            <p className="text-gray-700 text-base leading-relaxed text-justify">
              Since its inception in 2015, Daksh Mahila Vidyapeeth has been
              committed to shaping future educators with knowledge, values, and
              purpose. Approved by Chaudhary Charan Singh University, Meerut,
              our B.A. and B.Com programs are designed not only to prepare
              teachers, but also to inspire torchbearers of learning who will
